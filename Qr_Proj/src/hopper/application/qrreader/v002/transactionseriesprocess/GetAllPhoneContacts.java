...
public class GetAllPhoneContacts extends TransactionSeriesProcess{

	static{ 
		console.log("GetAllPhoneContacts LOADED");			
	}
	...
	public GetAllPhoneContacts(){
		console.log("GetAllPhoneContacts() instanated!!");
	}
	...
	public void processFirst(Object... objects){
		...
		toProcessArrayOfJson = phoneContacts.toArrayListOfJson();//SmsReceiver.getSmsSentAboveIdAsArrayListOfJson(MainActivity.activity, transportLayer.dataLayer.getField("lastId"));
